...
public class JsonUtilsTest {
    private static final String TEST_JSON_FILE1 = "jsonUtilsTest1.json",TEST_JSON_FILE2 = "jsonUtilsTest2.json",TEST_JSON_FILE3 = "jsonUtilsTest3.json";
    ...
    public void parseJson_should_return_correct_search_response_object(
        ...
        if (filesArray != null) {
            ...
            if ((stockFile.getAssetTypeId() != null) && !fileObj.isNull("media_type_id"))
